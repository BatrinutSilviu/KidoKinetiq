  ...
  return (
    <section className="relative overflow-hidden bg-cream py-16 px-6">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-900 text-navy mb-5 leading-tight">{title}</h1>
        {subtitle && (
          <p className="text-navy/60 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">{subtitle}</p>
        )}
      </div>
    </section>
  )
